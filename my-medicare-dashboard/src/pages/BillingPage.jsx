        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p>This page will be connected to the backend billing system once the API endpoints are available. Currently showing sample data for demonstration purposes.</p>
            </div>
          </div>
        </div>
      </div>
