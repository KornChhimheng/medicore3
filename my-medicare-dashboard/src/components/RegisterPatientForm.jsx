...
const RegisterPatientForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['email', 'password', 'firstName', 'lastName', 'contactNumber'];
    ...
    try {
      ...
      setMessage(error.response?.data?.message || 'Failed to register patient. Please try again.');
      setIsError(true);
    } finally {
