...
public class AuthenticationController {
    ...
    public ResponseEntity<BaseResponse<Void>> registerPatient(@Valid @RequestBody PatienRegister requestRegister){
        return ResponseEntity.ok(authenticationService.registerPatient(requestRegister));
    }
    @PostMapping("auth/doctor-register")
    public ResponseEntity<BaseResponse<Void>> registerDoctor(@Valid @RequestBody DoctorRequest requestRegister){
        return ResponseEntity.ok(authenticationService.registerDoctor(requestRegister));
    }
